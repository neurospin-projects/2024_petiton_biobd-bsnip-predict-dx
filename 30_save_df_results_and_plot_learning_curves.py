...
def get_list_mean_and_std(
    ...
    classifier : str
        Classifier name (e.g., "EN", "svm", "L2LR", "MLP", "xgboost", "densenet",
        "densenet with transfer").
    feature_type : str
        Feature type used for classification (e.g., "vbm_voxelwise", "VBM_ROI",
        "SBM_ROI", etc.).
    atlas : str
    ...
    # ===== Assertions for valid arguments =====
    valid_features = [
        "vbm_voxelwise", "VBM_ROI", "SBM_ROI", 
        "SBM_ROI_no_subcortical", "SBM_ROI_7subROI",

...
Transform = namedtuple("Transform", ["transform", "probability", "randomize_per_channel"])

"""
From https://github.com/neurospin-projects/2022_cambroise_surfaugment/tree/master 
    ...
    def __call__(self, arr):
        ...
        for transform in transforms.values():
            ...
            if isinstance(transformed, np.ndarray):
                ...
                raise TypeError(f"Unexpected type for transformed data: {type(transformed)}")
